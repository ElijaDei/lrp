...
public class WrapDistance {

        private Point2D myPosition;
        private Map<Point2D, WrapDistance> neighborLinks;
        ...
        public WrapDistance(Point2D myPosition, Map<Point2D, WrapDistance> neighborLinks) {
        ...
        public static void main(String[] args) {
            Map<Point2D, WrapDistance> neighborLinks = new HashMap<>();
            ...
            WrapDistance myNode = new WrapDistance(nodePos, neighborLinks);
