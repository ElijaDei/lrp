package com.github.elijadei.lrp.kdTrees;
...
public class KdTree {
    ...
    public void insert(Point2D p) {
        ...
        root = insert(root, p, true, new double[]{1, 6, 25, 10});
    }
    ...
    public static void main(String[] args) {
        ...
        Point2D p = new Point2D(1.0, 5.9);
        Point2D p1 = new Point2D(0.21, 1.9);
        Point2D p2 = new Point2D(3.03, 2.9);
        Point2D p3 = new Point2D(64.03, 29.9);
        RectHV ps = new RectHV(0.0, 10.2, 5.3, 50.3);
        double[] db = {1,5.0,6.0,9.0};
        Node nd =new Node(p,db);
       // kdtree.insert(nd, p, false, db);

        System.out.println(kdtree.nearest(p1));
        kdtree.insert(p);
        kdtree.insert(p1);
        kdtree.insert(p2);
        System.out.println(kdtree.nearest(p).distanceTo(p3));
        System.out.println(kdtree.contains(nd,p,true));
        System.out.println(kdtree.range(ps));
        kdtree.nearest(p2);
